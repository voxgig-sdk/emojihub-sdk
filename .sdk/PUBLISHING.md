...
|---|---|---|
| `ts/` | @voxgig-sdk/emojihub-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/emojihub-sdk \
      --repository voxgig-sdk/emojihub-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/emojihub-sdk` shows it, and
`npm trust revoke @voxgig-sdk/emojihub-sdk --id=<id>` removes it.
