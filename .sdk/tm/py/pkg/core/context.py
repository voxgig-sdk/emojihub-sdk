...
from projectname_sdk.core.control import EmojihubControl
...
class EmojihubContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, EmojihubResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, EmojihubResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return EmojihubError(code, msg, self)
