...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = EmojihubOmni.make_runner(TEST_JSON_FILE, EmojihubSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : EmojihubOmni.errify(err)
    end
