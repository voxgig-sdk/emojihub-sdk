...
{
    private static function utility(): EmojihubUtility
    {
        return new EmojihubUtility();
    }
    ...
    private static function ctx(array $over = []): EmojihubContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new EmojihubContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new EmojihubOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof EmojihubError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new EmojihubOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = EmojihubMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new EmojihubOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = EmojihubMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new EmojihubOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = EmojihubMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new EmojihubSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = EmojihubMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new EmojihubResponse([]),
            'result' => new EmojihubResult([]),
        ]);
        [, $err] = EmojihubMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new EmojihubSpec([]),
            'response' => null,
            'result' => new EmojihubResult([]),
        ]);
        [, $err] = EmojihubMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new EmojihubSpec(['step' => 's']),
            'response' => new EmojihubResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new EmojihubResult([]),
        ]);
        [, $err] = EmojihubMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new EmojihubSpec(['step' => 's']),
            'response' => new EmojihubResponse(self::resp(200, ['v' => 1])),
            'result' => new EmojihubResult([]),
        ]);
        [, $err] = EmojihubMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new EmojihubSpec(['step' => 's']),
            'response' => new EmojihubResponse(self::resp(200, ['v' => 2])),
            'result' => new EmojihubResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        EmojihubMakeResponse::call($ctx);
    ...
    {
        $preset = new EmojihubResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new EmojihubSpec([]),
            'response' => new EmojihubResponse([]),
            'result' => new EmojihubResult([]),
        ...
        [$got, $err] = EmojihubMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new EmojihubResult([])]);
        [, $err] = EmojihubMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new EmojihubSpec([]), 'result' => null]);
        [, $err] = EmojihubMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new EmojihubSpec(['step' => 's']),
            'result' => new EmojihubResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new EmojihubOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = EmojihubMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new EmojihubSpec(['step' => 's']),
            'result' => new EmojihubResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new EmojihubOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = EmojihubMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new EmojihubResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new EmojihubSpec([]),
            'result' => new EmojihubResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = EmojihubMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = EmojihubMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new EmojihubError('boom', 'boom');
        $utility->fetcher = function (EmojihubContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new EmojihubSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = EmojihubMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (EmojihubContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = EmojihubMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(EmojihubResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (EmojihubContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new EmojihubSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = EmojihubMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new EmojihubResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new EmojihubSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = EmojihubMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = EmojihubMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = EmojihubMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new EmojihubResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, EmojihubDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new EmojihubResult(['ok' => false])]);
        $this->expectException(EmojihubError::class);
        EmojihubDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new EmojihubResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', EmojihubMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        EmojihubMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new EmojihubBaseFeature();
        $b = new EmojihubBaseFeature();
        EmojihubFeatureAdd::call($ctx, $a);
        EmojihubFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): EmojihubBaseFeature
    {
        $f = new EmojihubBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        EmojihubFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): EmojihubContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new EmojihubSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = EmojihubPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new EmojihubResponse(['headers' => null]),
            'result' => new EmojihubResult([]),
        ]);
        EmojihubResultHeaders::call($ctx);
