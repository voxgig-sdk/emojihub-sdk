...
// Emojihub SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = EmojihubOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(EmojihubOmni::structfix($now, Struct::undef()))
                        !== json_encode(EmojihubOmni::structfix($val, Struct::undef()))) {
