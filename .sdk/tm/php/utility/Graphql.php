...
class EmojihubGraphql
{
    ...
    // equivalent.
    public static function body(EmojihubContext $ctx): mixed
    {
    ...
    public static function errors(EmojihubContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
