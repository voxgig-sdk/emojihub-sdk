...
// Emojihub SDK clienttrack feature
...
class EmojihubClienttrackFeature extends EmojihubBaseFeature
{
    ...
    public function PostConstruct(EmojihubContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'Emojihub-SDK';
