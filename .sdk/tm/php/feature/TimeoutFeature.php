...
class EmojihubTimeoutFeature extends EmojihubBaseFeature
{
    ...
    private function _with_timeout(EmojihubContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(EmojihubContext $_ctx, float $ms): void
    {
        $client = $this->client;
