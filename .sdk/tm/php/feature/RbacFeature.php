...
class EmojihubRbacFeature extends EmojihubBaseFeature
{
    ...
    private function _required(EmojihubContext $ctx): ?string
    {
    ...
    private function _reject(EmojihubContext $ctx, string $required): void
    {
    ...
    private function _track(EmojihubContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
