...
// Emojihub SDK streaming feature
...
class EmojihubStreamingFeature extends EmojihubBaseFeature
{
    ...
    private function _iterate(EmojihubResult $result): \Generator
    {
    ...
    private function _streamable(EmojihubContext $ctx): bool
    {
