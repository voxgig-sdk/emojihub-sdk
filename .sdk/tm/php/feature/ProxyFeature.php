...
class EmojihubProxyFeature extends EmojihubBaseFeature
{
    ...
    public function init(EmojihubContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (EmojihubContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
