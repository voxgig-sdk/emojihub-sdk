...
// Emojihub SDK ratelimit feature
...
class EmojihubRatelimitFeature extends EmojihubBaseFeature
{
    ...
    private function _acquire(EmojihubContext $ctx): void
    {
    ...
    private function _track(EmojihubContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
