...
class EmojihubCacheFeature extends EmojihubBaseFeature
{
    ...
    private function _through(EmojihubContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
