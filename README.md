...
Get random emojis or access the entire emoji database by category or group.

Learn more about EmojiHub at [emojihub.yurace.pro](https://emojihub.yurace.pro).
...
This SDK exposes the API as a small set of **semantic entities** — All, Category, Group, Random, Search and Similar — that you
