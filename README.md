...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/emojihub` | `npm install @voxgig-sdk/emojihub` |
| Python | `voxgig-sdk-emojihub` | `pip install voxgig-sdk-emojihub` |
| PHP | `voxgig-sdk/emojihub` | `composer require voxgig-sdk/emojihub` |
| Golang | `github.com/voxgig-sdk/emojihub-sdk/go` | `go get github.com/voxgig-sdk/emojihub-sdk/go` |
| Ruby | `voxgig-sdk-emojihub` | `gem install voxgig-sdk-emojihub` |
| Lua | `voxgig-sdk-emojihub` | `luarocks install voxgig-sdk-emojihub` |
