...
class CategoryEntity
  ...
  # @return [Category, Hash] the loaded Category; raises EmojihubError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Category>, Array] the matching Category items; raises EmojihubError on failure
