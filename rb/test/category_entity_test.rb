...
class CategoryEntityTest < Minitest::Test
  ...
  def test_stream
    ...
    base = EmojihubSDK.test(seed, nil)
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set EMOJIHUB_TEST_CATEGORY_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def category_basic_setup(extra)
  ...
  entid_env_raw = ENV["EMOJIHUB_TEST_CATEGORY_ENTID"]
