...
module EmojihubTestRunner
  ...
  def self.env_override(m)
    live = getenv("EMOJIHUB_TEST_LIVE")
    override = getenv("EMOJIHUB_TEST_OVERRIDE")
    ...
    explain = getenv("EMOJIHUB_TEST_EXPLAIN")
    m["EMOJIHUB_TEST_EXPLAIN"] = explain if explain && !explain.empty?
...
Runner = EmojihubTestRunner
Helpers = EmojihubHelpers
Vs = VoxgigStruct
