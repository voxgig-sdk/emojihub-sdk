...
function basicSetup(extra?: any) {
  ...
  idmap = env['EMOJIHUB_TEST_RANDOM_ENTID']

  const live = 'TRUE' === env.EMOJIHUB_TEST_LIVE

  const transport = createLiveTransport()
  if (live) {
    const rawIds = process.env['EMOJIHUB_TEST_RANDOM_ENTID']
