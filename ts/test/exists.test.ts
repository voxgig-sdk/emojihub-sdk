...
describe('exists', async () => {
  ...
  //
  // EmojihubSDK.test() is synchronous — it returns the client, not a promise
  ...
  test('test-mode', () => {
    ...
    equal(testsdk instanceof EmojihubSDK, true,
      'EmojihubSDK.test() must return a client synchronously')
  })
