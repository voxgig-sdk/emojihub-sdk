# Emojihub TypeScript SDK Reference

Complete API reference for the Emojihub TypeScript SDK.
...
```ts
new EmojihubSDK(options?: object)
```
...
#### `EmojihubSDK.test(testopts?, sdkopts?)`
...
**Returns:** `EmojihubSDK` instance in test mode.
...
Return the parent `EmojihubSDK` instance.
