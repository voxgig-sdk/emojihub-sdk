...
(0, node_test_1.describe)('SimilarEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if (!live && (0, utility_1.maybeSkipControl)(t, 'entityOp', 'similar.' + op, live))
                return;
        }
        ...
        (0, node_assert_1.default)(similar_ref01_data_dt0.id === similar_ref01_data.id);
    });
});
