...
function envOverride(m) {
    if ('TRUE' === process.env.EMOJIHUB_TEST_LIVE ||
        'TRUE' === process.env.EMOJIHUB_TEST_OVERRIDE) {
    ...
    m.EMOJIHUB_TEST_EXPLAIN = process.env.EMOJIHUB_TEST_EXPLAIN || m.EMOJIHUB_TEST_EXPLAIN;
    return m;
}
