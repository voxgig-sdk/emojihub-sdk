...
// Emojihub SDK utility: fetcher

class EmojihubFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; EmojihubSDK/1.0)';
    ...
    public static function call(EmojihubContext $ctx, string $fullurl, array $fetchdef): array
    {
