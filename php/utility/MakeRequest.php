...
// Emojihub SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class EmojihubMakeRequest
{
    public static function call(EmojihubContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new EmojihubResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new EmojihubResponse($fetched);
        } else {
