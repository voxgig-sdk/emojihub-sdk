...
class EmojihubTestRunner
{
    ...
    {
        $live = self::getenv('EMOJIHUB_TEST_LIVE');
        $override = self::getenv('EMOJIHUB_TEST_OVERRIDE');
        ...
        $explain = self::getenv('EMOJIHUB_TEST_EXPLAIN');
...
class_alias('EmojihubTestRunner', 'Runner');
class_alias('EmojihubHelpers', 'Helpers');
