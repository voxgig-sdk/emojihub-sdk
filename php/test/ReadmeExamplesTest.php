...
// Emojihub SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (EmojihubSDK::test)
...
{
    private const SDK_CLASS = 'EmojihubSDK';
    ...
    private const SDK_BASE = 'emojihub_sdk';
