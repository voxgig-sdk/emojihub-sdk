...
{
    public function test_direct_load_similar(): void
    {
        $setup = similar_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-similar", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
