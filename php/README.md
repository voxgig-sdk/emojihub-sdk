...
The PHP SDK for the Emojihub API. Provides an entity-oriented interface using PHP conventions.
...
[$result, $err] = $client->Emojihub(null)->load(
    ["id" => "test01"], null
);
...
```
php/
├── emojihub_sdk.php          -- Main SDK class
...
The main class (`emojihub_sdk.php`) exports the SDK class
