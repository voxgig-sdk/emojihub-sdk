...
class EmojihubNetsimFeature extends EmojihubBaseFeature
{
    ...
    private function _simulate(EmojihubContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(EmojihubContext $ctx, array $applied): void
    {
        $client = $this->client;
