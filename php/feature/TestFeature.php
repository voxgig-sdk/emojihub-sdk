...
// Emojihub SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class EmojihubTestFeature extends EmojihubBaseFeature
{
    ...
    public function init(EmojihubContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (EmojihubContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (EmojihubContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(EmojihubContext $ctx, $op, $args): array
    {
