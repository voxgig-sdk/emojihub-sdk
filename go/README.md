...
The Golang SDK for the Emojihub API. Provides an entity-oriented interface using standard Go conventions — no generics required, data flows as `map[string]any`.


## Install
```bash
go get github.com/voxgig-sdk/emojihub-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/emojihub-sdk=../path/to/github.com/voxgig-sdk/emojihub-sdk
```
...
| `All` | `(data map[string]any) EmojihubEntity` | Create a All entity instance. |
...
```
github.com/voxgig-sdk/emojihub-sdk/
...
The root package (`github.com/voxgig-sdk/emojihub-sdk`) re-exports everything needed
