...
const testSeed = `map[string]any{"entity": map[string]any{"all": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "category": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "group": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "random": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "search": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "similar": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
