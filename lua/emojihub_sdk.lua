...
local EmojihubSDK = {}
EmojihubSDK.__index = EmojihubSDK
...
EmojihubSDK._make_feature = _make_feature


function EmojihubSDK.new(options)
  local self = setmetatable({}, EmojihubSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function EmojihubSDK:options_map()
...
function EmojihubSDK:get_utility()
  return Utility.copy(self._utility)
end


function EmojihubSDK:get_root_ctx()
  return self._rootctx
end


function EmojihubSDK:prepare(fetchargs)
...
function EmojihubSDK:direct(fetchargs)
...
-- by passing it.
function EmojihubSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function EmojihubSDK:graphql(query, variables, ctrl)
  ...
  if type(errors) == "table" and 0 < #errors then
    ...
    res.ok = false
    res.err = "EmojihubSDK: graphql: " .. msg
    res.graphql = errors
  end
...
function EmojihubSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = EmojihubSDK.new(sdkopts)
  sdk.mode = "test"
