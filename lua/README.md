...
The Lua SDK for the Emojihub API. Provides an entity-oriented interface using Lua conventions.
...
local result, err = client:Emojihub(nil):load(
  { id = "test01" }, nil
)
...
```
lua/
├── emojihub_sdk.lua    -- Main SDK module
...
The main module (`emojihub_sdk`) exports the SDK constructor
