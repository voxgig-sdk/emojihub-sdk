...
-- data to return.
local TEST_SEED = '{ entity = { ["all"] = { ["test01"] = { id = "test01" } }, ["category"] = { ["test01"] = { id = "test01" } }, ["group"] = { ["test01"] = { id = "test01" } }, ["random"] = { ["test01"] = { id = "test01" } }, ["search"] = { ["test01"] = { id = "test01" } }, ["similar"] = { ["test01"] = { id = "test01" } } } }'
