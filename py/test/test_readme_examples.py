# Emojihub SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions EmojihubSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both EmojihubSDK(...) and EmojihubSDK.test(...) become
#      EmojihubSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "emojihub_sdk"
_SDK_CLASS = "EmojihubSDK"
