...
The Python SDK for the Emojihub API — an entity-oriented client following Pythonic conventions.
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/emojihub-sdk/releases)) or
