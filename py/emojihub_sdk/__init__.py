...
from emojihub_sdk.utility import register

# Load features
from emojihub_sdk.feature.base_feature import EmojihubBaseFeature
from emojihub_sdk.features import _has_feature, _make_feature
...
class EmojihubSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = EmojihubUtility()
        self._utility = utility

        from emojihub_sdk.config import shared_config
    ...
    def get_utility(self):
        return EmojihubUtility.copy(self._utility)
    ...
    def _op_denied(self, op):
        ...
        return {
            "ok": False,
            "err": Exception(
                "EmojihubSDK: " + op + ": operation not allowed by"
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("EmojihubSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def All(self, data=None) -> "AllEntity":
        ...
        from emojihub_sdk.entity.all_entity import AllEntity
    ...
    def Random(self, data=None) -> "RandomEntity":
        ...
        from emojihub_sdk.entity.random_entity import RandomEntity
        return RandomEntity(self, data)


    def Search(self, data=None) -> "SearchEntity":
        """Entity factory: client.Search().list() / client.Search().load({"id": ...})."""
        from emojihub_sdk.entity.search_entity import SearchEntity
        return SearchEntity(self, data)


    def Similar(self, data=None) -> "SimilarEntity":
        """Entity factory: client.Similar().list() / client.Similar().load({"id": ...})."""
        from emojihub_sdk.entity.similar_entity import SimilarEntity
