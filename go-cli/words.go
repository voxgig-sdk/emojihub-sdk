...
func registerSDKWords(r *eng.Registry, client *sdk.EmojihubSDK) {
...
func runOp(client *sdk.EmojihubSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
